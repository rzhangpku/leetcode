...
Update time:  2019-06-15 22:13:48

Auto created by [leetcode_generate](https://github.com/bonfy/leetcode)

I have solved **151   /   1023** problems
while there are **153** problems still locked.

If you want to use this tool please follow this [Usage Guide](https://github.com/bonfy/leetcode/blob/master/README_leetcode_generate.md)

If you have any question, please give me an [issue](https://github.com/rzhangpku/leetcode/issues).
...
|:---:|:---:|:---:|:---:|:---:|
|1|[two-sum](https://leetcode.com/problems/two-sum)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/001-two-sum/two-sum.py)|[:memo:](https://leetcode.com/articles/two-sum/)|Easy|
|2|[add-two-numbers](https://leetcode.com/problems/add-two-numbers)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/002-add-two-numbers/add-two-numbers.py)|[:memo:](https://leetcode.com/articles/add-two-numbers/)|Medium|
...
|7|[reverse-integer](https://leetcode.com/problems/reverse-integer)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/007-reverse-integer/reverse-integer.py)|[:memo:](https://leetcode.com/articles/reverse-integer/)|Easy|
|8|[string-to-integer-atoi](https://leetcode.com/problems/string-to-integer-atoi)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/008-string-to-integer-atoi/string-to-integer-atoi.py)||Medium|
|9|[palindrome-number](https://leetcode.com/problems/palindrome-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/009-palindrome-number/palindrome-number.py)|[:memo:](https://leetcode.com/articles/palindrome-number/)|Easy|
...
|13|[roman-to-integer](https://leetcode.com/problems/roman-to-integer)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/013-roman-to-integer/roman-to-integer.py)||Easy|
|14|[longest-common-prefix](https://leetcode.com/problems/longest-common-prefix)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/014-longest-common-prefix/longest-common-prefix.py)|[:memo:](https://leetcode.com/articles/longest-common-prefix/)|Easy|
...
|21|[merge-two-sorted-lists](https://leetcode.com/problems/merge-two-sorted-lists)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/021-merge-two-sorted-lists/merge-two-sorted-lists.py)|[:memo:](https://leetcode.com/articles/merged-two-sorted-lists/)|Easy|
...
|28|[implement-strstr](https://leetcode.com/problems/implement-strstr)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/028-implement-strstr/implement-strstr.py)||Easy|
...
|34|[find-first-and-last-position-of-element-in-sorted-array](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/034-find-first-and-last-position-of-element-in-sorted-array/find-first-and-last-position-of-element-in-sorted-array.py)|[:memo:](https://leetcode.com/articles/find-first-and-last-position-element-sorted-array/)|Medium|
|35|[search-insert-position](https://leetcode.com/problems/search-insert-position)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/035-search-insert-position/search-insert-position.py)||Easy|
...
|50|[powx-n](https://leetcode.com/problems/powx-n)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/050-powx-n/powx-n.py)|[:memo:](https://leetcode.com/articles/powx-n/)|Medium|
...
|58|[length-of-last-word](https://leetcode.com/problems/length-of-last-word)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/058-length-of-last-word/length-of-last-word.py)||Easy|
...
|65|[valid-number](https://leetcode.com/problems/valid-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/065-valid-number/valid-number.py)||Hard|
|66|[plus-one](https://leetcode.com/problems/plus-one)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/066-plus-one/plus-one.py)||Easy|
|67|[add-binary](https://leetcode.com/problems/add-binary)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/067-add-binary/add-binary.py)||Easy|
|68|[text-justification](https://leetcode.com/problems/text-justification)|||Hard|
|69|[sqrtx](https://leetcode.com/problems/sqrtx)|||Easy|
|70|[climbing-stairs](https://leetcode.com/problems/climbing-stairs)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/070-climbing-stairs/climbing-stairs.py)|[:memo:](https://leetcode.com/articles/climbing-stairs/)|Easy|
...
|83|[remove-duplicates-from-sorted-list](https://leetcode.com/problems/remove-duplicates-from-sorted-list)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/083-remove-duplicates-from-sorted-list/remove-duplicates-from-sorted-list.py)|[:memo:](https://leetcode.com/articles/remove-duplicates-from-sorted-list/)|Easy|
...
|100|[same-tree](https://leetcode.com/problems/same-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/100-same-tree/same-tree.py)|[:memo:](https://leetcode.com/articles/same-tree/)|Easy|
...
|104|[maximum-depth-of-binary-tree](https://leetcode.com/problems/maximum-depth-of-binary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/104-maximum-depth-of-binary-tree/maximum-depth-of-binary-tree.py)|[:memo:](https://leetcode.com/articles/maximum-depth-of-binary-tree/)|Easy|
...
|108|[convert-sorted-array-to-binary-search-tree](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/108-convert-sorted-array-to-binary-search-tree/convert-sorted-array-to-binary-search-tree.py)||Easy|
...
|112|[path-sum](https://leetcode.com/problems/path-sum)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/112-path-sum/path-sum.py)|[:memo:](https://leetcode.com/articles/path-sum/)|Easy|
...
|118|[pascals-triangle](https://leetcode.com/problems/pascals-triangle)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/118-pascals-triangle/pascals-triangle.py)|[:memo:](https://leetcode.com/articles/pascals-triangle/)|Easy|
|119|[pascals-triangle-ii](https://leetcode.com/problems/pascals-triangle-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/119-pascals-triangle-ii/pascals-triangle-ii.py)||Easy|
...
|125|[valid-palindrome](https://leetcode.com/problems/valid-palindrome)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/125-valid-palindrome/valid-palindrome.py)||Easy|
...
|155|[min-stack](https://leetcode.com/problems/min-stack)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/155-min-stack/min-stack.py)||Easy|
...
|162|[find-peak-element](https://leetcode.com/problems/find-peak-element)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/162-find-peak-element/find-peak-element.py)|[:memo:](https://leetcode.com/articles/find-peak-element/)|Medium|
...
|165|[compare-version-numbers](https://leetcode.com/problems/compare-version-numbers)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/165-compare-version-numbers/compare-version-numbers.py)||Medium|
...
|167|[two-sum-ii-input-array-is-sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/167-two-sum-ii-input-array-is-sorted/two-sum-ii-input-array-is-sorted.py)|[:memo:](https://leetcode.com/articles/two-sum-ii-input-array-is-sorted/)|Easy|
|168|[excel-sheet-column-title](https://leetcode.com/problems/excel-sheet-column-title)|||Easy|
|169|[majority-element](https://leetcode.com/problems/majority-element)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/169-majority-element/majority-element.py)|[:memo:](https://leetcode.com/articles/majority-element/)|Easy|
...
|190|[reverse-bits](https://leetcode.com/problems/reverse-bits)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/190-reverse-bits/reverse-bits.py)||Easy|
|191|[number-of-1-bits](https://leetcode.com/problems/number-of-1-bits)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/191-number-of-1-bits/number-of-1-bits.py)|[:memo:](https://leetcode.com/articles/number-1-bits/)|Easy|
...
|202|[happy-number](https://leetcode.com/problems/happy-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/202-happy-number/happy-number.py)||Easy|
|203|[remove-linked-list-elements](https://leetcode.com/problems/remove-linked-list-elements)|||Easy|
|204|[count-primes](https://leetcode.com/problems/count-primes)|||Easy|
|205|[isomorphic-strings](https://leetcode.com/problems/isomorphic-strings)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/205-isomorphic-strings/isomorphic-strings.py)||Easy|
|206|[reverse-linked-list](https://leetcode.com/problems/reverse-linked-list)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/206-reverse-linked-list/reverse-linked-list.py)|[:memo:](https://leetcode.com/articles/reverse-linked-list/)|Easy|
...
|215|[kth-largest-element-in-an-array](https://leetcode.com/problems/kth-largest-element-in-an-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/215-kth-largest-element-in-an-array/kth-largest-element-in-an-array.py)|[:memo:](https://leetcode.com/articles/kth-largest-element-in-an-array/)|Medium|
|216|[combination-sum-iii](https://leetcode.com/problems/combination-sum-iii)|||Medium|
|217|[contains-duplicate](https://leetcode.com/problems/contains-duplicate)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/217-contains-duplicate/contains-duplicate.py)|[:memo:](https://leetcode.com/articles/contains-duplicate/)|Easy|
...
|225|[implement-stack-using-queues](https://leetcode.com/problems/implement-stack-using-queues)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/225-implement-stack-using-queues/implement-stack-using-queues.py)|[:memo:](https://leetcode.com/articles/implement-stack-using-queues/)|Easy|
|226|[invert-binary-tree](https://leetcode.com/problems/invert-binary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/226-invert-binary-tree/invert-binary-tree.py)|[:memo:](https://leetcode.com/articles/invert-binary-tree/)|Easy|
...
|231|[power-of-two](https://leetcode.com/problems/power-of-two)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/231-power-of-two/power-of-two.py)||Easy|
|232|[implement-queue-using-stacks](https://leetcode.com/problems/implement-queue-using-stacks)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/232-implement-queue-using-stacks/implement-queue-using-stacks.py)|[:memo:](https://leetcode.com/articles/implement-queue-using-stacks/)|Easy|
...
|234|[palindrome-linked-list](https://leetcode.com/problems/palindrome-linked-list)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/234-palindrome-linked-list/palindrome-linked-list.py)||Easy|
...
|242|[valid-anagram](https://leetcode.com/problems/valid-anagram)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/242-valid-anagram/valid-anagram.py)|[:memo:](https://leetcode.com/articles/valid-anagram/)|Easy|
...
|258|[add-digits](https://leetcode.com/problems/add-digits)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/258-add-digits/add-digits.py)||Easy|
|259|[3sum-smaller](https://leetcode.com/problems/3sum-smaller)|:lock:|[:memo:](https://leetcode.com/articles/3sum-smaller/)|Medium|
|260|[single-number-iii](https://leetcode.com/problems/single-number-iii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/260-single-number-iii/single-number-iii.py)||Medium|
|261|[graph-valid-tree](https://leetcode.com/problems/graph-valid-tree)|:lock:||Medium|
|263|[ugly-number](https://leetcode.com/problems/ugly-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/263-ugly-number/ugly-number.py)||Easy|
...
|278|[first-bad-version](https://leetcode.com/problems/first-bad-version)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/278-first-bad-version/first-bad-version.py)|[:memo:](https://leetcode.com/articles/first-bad-version/)|Easy|
...
|290|[word-pattern](https://leetcode.com/problems/word-pattern)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/290-word-pattern/word-pattern.py)||Easy|
...
|303|[range-sum-query-immutable](https://leetcode.com/problems/range-sum-query-immutable)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/303-range-sum-query-immutable/range-sum-query-immutable.py)|[:memo:](https://leetcode.com/articles/range-sum-query-immutable/)|Easy|
...
|326|[power-of-three](https://leetcode.com/problems/power-of-three)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/326-power-of-three/power-of-three.py)|[:memo:](https://leetcode.com/articles/power-of-three/)|Easy|
...
|338|[counting-bits](https://leetcode.com/problems/counting-bits)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/338-counting-bits/counting-bits.py)|[:memo:](https://leetcode.com/articles/counting-bits/)|Medium|
...
|342|[power-of-four](https://leetcode.com/problems/power-of-four)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/342-power-of-four/power-of-four.py)||Easy|
|343|[integer-break](https://leetcode.com/problems/integer-break)|||Medium|
|344|[reverse-string](https://leetcode.com/problems/reverse-string)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/344-reverse-string/reverse-string.py)||Easy|
...
|347|[top-k-frequent-elements](https://leetcode.com/problems/top-k-frequent-elements)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/347-top-k-frequent-elements/top-k-frequent-elements.py)|[:memo:](https://leetcode.com/articles/top-k-frequent-elements/)|Medium|
|348|[design-tic-tac-toe](https://leetcode.com/problems/design-tic-tac-toe)|:lock:||Medium|
|349|[intersection-of-two-arrays](https://leetcode.com/problems/intersection-of-two-arrays)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/349-intersection-of-two-arrays/intersection-of-two-arrays.py)|[:memo:](https://leetcode.com/articles/intersection-of-two-arrays/)|Easy|
|350|[intersection-of-two-arrays-ii](https://leetcode.com/problems/intersection-of-two-arrays-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/350-intersection-of-two-arrays-ii/intersection-of-two-arrays-ii.py)||Easy|
...
|367|[valid-perfect-square](https://leetcode.com/problems/valid-perfect-square)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/367-valid-perfect-square/valid-perfect-square.py)||Easy|
...
|371|[sum-of-two-integers](https://leetcode.com/problems/sum-of-two-integers)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/371-sum-of-two-integers/sum-of-two-integers.py)||Easy|
|372|[super-pow](https://leetcode.com/problems/super-pow)|||Medium|
|373|[find-k-pairs-with-smallest-sums](https://leetcode.com/problems/find-k-pairs-with-smallest-sums)|||Medium|
|374|[guess-number-higher-or-lower](https://leetcode.com/problems/guess-number-higher-or-lower)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/374-guess-number-higher-or-lower/guess-number-higher-or-lower.py)|[:memo:](https://leetcode.com/articles/guess-number-higher-or-lower/)|Easy|
...
|383|[ransom-note](https://leetcode.com/problems/ransom-note)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/383-ransom-note/ransom-note.py)||Easy|
...
|387|[first-unique-character-in-a-string](https://leetcode.com/problems/first-unique-character-in-a-string)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/387-first-unique-character-in-a-string/first-unique-character-in-a-string.py)|[:memo:](https://leetcode.com/articles/first-unique-character-in-a-string/)|Easy|
|388|[longest-absolute-file-path](https://leetcode.com/problems/longest-absolute-file-path)|||Medium|
|389|[find-the-difference](https://leetcode.com/problems/find-the-difference)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/389-find-the-difference/find-the-difference.py)||Easy|
...
|404|[sum-of-left-leaves](https://leetcode.com/problems/sum-of-left-leaves)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/404-sum-of-left-leaves/sum-of-left-leaves.py)||Easy|
...
|412|[fizz-buzz](https://leetcode.com/problems/fizz-buzz)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/412-fizz-buzz/fizz-buzz.py)|[:memo:](https://leetcode.com/articles/fizz-buzz/)|Easy|
...
|414|[third-maximum-number](https://leetcode.com/problems/third-maximum-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/414-third-maximum-number/third-maximum-number.py)||Easy|
...
|434|[number-of-segments-in-a-string](https://leetcode.com/problems/number-of-segments-in-a-string)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/434-number-of-segments-in-a-string/number-of-segments-in-a-string.py)|[:memo:](https://leetcode.com/articles/number-of-segments-in-a-string/)|Easy|
...
|441|[arranging-coins](https://leetcode.com/problems/arranging-coins)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/441-arranging-coins/arranging-coins.py)||Easy|
|442|[find-all-duplicates-in-an-array](https://leetcode.com/problems/find-all-duplicates-in-an-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/442-find-all-duplicates-in-an-array/find-all-duplicates-in-an-array.py)||Medium|
...
|448|[find-all-numbers-disappeared-in-an-array](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/448-find-all-numbers-disappeared-in-an-array/find-all-numbers-disappeared-in-an-array.py)||Easy|
...
|451|[sort-characters-by-frequency](https://leetcode.com/problems/sort-characters-by-frequency)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/451-sort-characters-by-frequency/sort-characters-by-frequency.py)||Medium|
...
|461|[hamming-distance](https://leetcode.com/problems/hamming-distance)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/461-hamming-distance/hamming-distance.py)||Easy|
|462|[minimum-moves-to-equal-array-elements-ii](https://leetcode.com/problems/minimum-moves-to-equal-array-elements-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/462-minimum-moves-to-equal-array-elements-ii/minimum-moves-to-equal-array-elements-ii.py)|[:memo:](https://leetcode.com/articles/minimum-moves-to-equal-array-elements-ii/)|Medium|
|463|[island-perimeter](https://leetcode.com/problems/island-perimeter)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/463-island-perimeter/island-perimeter.py)||Easy|
...
|476|[number-complement](https://leetcode.com/problems/number-complement)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/476-number-complement/number-complement.py)||Easy|
...
|485|[max-consecutive-ones](https://leetcode.com/problems/max-consecutive-ones)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/485-max-consecutive-ones/max-consecutive-ones.py)||Easy|
...
|492|[construct-the-rectangle](https://leetcode.com/problems/construct-the-rectangle)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/492-construct-the-rectangle/construct-the-rectangle.py)||Easy|
...
|496|[next-greater-element-i](https://leetcode.com/problems/next-greater-element-i)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/496-next-greater-element-i/next-greater-element-i.py)|[:memo:](https://leetcode.com/articles/greater-element-i/)|Easy|
...
|500|[keyboard-row](https://leetcode.com/problems/keyboard-row)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/500-keyboard-row/keyboard-row.py)||Easy|
...
|520|[detect-capital](https://leetcode.com/problems/detect-capital)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/520-detect-capital/detect-capital.py)||Easy|
|521|[longest-uncommon-subsequence-i](https://leetcode.com/problems/longest-uncommon-subsequence-i)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/521-longest-uncommon-subsequence-i/longest-uncommon-subsequence-i.py)|[:memo:](https://leetcode.com/articles/longest-uncommon-subsequence-i/)|Easy|
...
|540|[single-element-in-a-sorted-array](https://leetcode.com/problems/single-element-in-a-sorted-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/540-single-element-in-a-sorted-array/single-element-in-a-sorted-array.py)||Medium|
|541|[reverse-string-ii](https://leetcode.com/problems/reverse-string-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/541-reverse-string-ii/reverse-string-ii.py)|[:memo:](https://leetcode.com/articles/reverse-string-ii/)|Easy|
...
|551|[student-attendance-record-i](https://leetcode.com/problems/student-attendance-record-i)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/551-student-attendance-record-i/student-attendance-record-i.py)|[:memo:](https://leetcode.com/articles/student-attendance-record-i/)|Easy|
...
|553|[optimal-division](https://leetcode.com/problems/optimal-division)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/553-optimal-division/optimal-division.py)|[:memo:](https://leetcode.com/articles/optimal-division/)|Medium|
...
|557|[reverse-words-in-a-string-iii](https://leetcode.com/problems/reverse-words-in-a-string-iii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/557-reverse-words-in-a-string-iii/reverse-words-in-a-string-iii.py)|[:memo:](https://leetcode.com/articles/reverse-words-in-a-string/)|Easy|
...
|566|[reshape-the-matrix](https://leetcode.com/problems/reshape-the-matrix)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/566-reshape-the-matrix/reshape-the-matrix.py)|[:memo:](https://leetcode.com/articles/reshape-the-matrix/)|Easy|
...
|575|[distribute-candies](https://leetcode.com/problems/distribute-candies)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/575-distribute-candies/distribute-candies.py)|[:memo:](https://leetcode.com/articles/distribute-candies/)|Easy|
...
|598|[range-addition-ii](https://leetcode.com/problems/range-addition-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/598-range-addition-ii/range-addition-ii.py)|[:memo:](https://leetcode.com/articles/range-addition-ii/)|Easy|
|599|[minimum-index-sum-of-two-lists](https://leetcode.com/problems/minimum-index-sum-of-two-lists)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/599-minimum-index-sum-of-two-lists/minimum-index-sum-of-two-lists.py)|[:memo:](https://leetcode.com/articles/minimum-index-sum-of-two-lists/)|Easy|
...
|606|[construct-string-from-binary-tree](https://leetcode.com/problems/construct-string-from-binary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/606-construct-string-from-binary-tree/construct-string-from-binary-tree.py)|[:memo:](https://leetcode.com/articles/construct-string-from-binary-tree/)|Easy|
...
|617|[merge-two-binary-trees](https://leetcode.com/problems/merge-two-binary-trees)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/617-merge-two-binary-trees/merge-two-binary-trees.py)|[:memo:](https://leetcode.com/articles/merge-two-binary-trees/)|Easy|
...
|647|[palindromic-substrings](https://leetcode.com/problems/palindromic-substrings)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/647-palindromic-substrings/palindromic-substrings.py)|[:memo:](https://leetcode.com/articles/palindromic-substrings/)|Medium|
...
|657|[robot-return-to-origin](https://leetcode.com/problems/robot-return-to-origin)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/657-robot-return-to-origin/robot-return-to-origin.py)|[:memo:](https://leetcode.com/articles/judge-route-circle/)|Easy|
...
|669|[trim-a-binary-search-tree](https://leetcode.com/problems/trim-a-binary-search-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/669-trim-a-binary-search-tree/trim-a-binary-search-tree.py)|[:memo:](https://leetcode.com/articles/trim-a-binary-search-tree/)|Easy|
|670|[maximum-swap](https://leetcode.com/problems/maximum-swap)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/670-maximum-swap/maximum-swap.py)|[:memo:](https://leetcode.com/articles/maximum-swap/)|Medium|
|671|[second-minimum-node-in-a-binary-tree](https://leetcode.com/problems/second-minimum-node-in-a-binary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/671-second-minimum-node-in-a-binary-tree/second-minimum-node-in-a-binary-tree.py)|[:memo:](https://leetcode.com/articles/second-minimum-node-in-a-binary-tree/)|Easy|
...
|677|[map-sum-pairs](https://leetcode.com/problems/map-sum-pairs)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/677-map-sum-pairs/map-sum-pairs.py)|[:memo:](https://leetcode.com/articles/map-sum-pairs/)|Medium|
...
|682|[baseball-game](https://leetcode.com/problems/baseball-game)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/682-baseball-game/baseball-game.py)|[:memo:](https://leetcode.com/articles/baseball-game/)|Easy|
...
|693|[binary-number-with-alternating-bits](https://leetcode.com/problems/binary-number-with-alternating-bits)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/693-binary-number-with-alternating-bits/binary-number-with-alternating-bits.py)|[:memo:](https://leetcode.com/articles/binary-number-with-alternating-bits/)|Easy|
...
|724|[find-pivot-index](https://leetcode.com/problems/find-pivot-index)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/724-find-pivot-index/find-pivot-index.py)|[:memo:](https://leetcode.com/articles/find-pivot-index/)|Easy|
...
|728|[self-dividing-numbers](https://leetcode.com/problems/self-dividing-numbers)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/728-self-dividing-numbers/self-dividing-numbers.py)|[:memo:](https://leetcode.com/articles/self-dividing-numbers/)|Easy|
...
|742|[to-lower-case](https://leetcode.com/problems/to-lower-case)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/742-to-lower-case/to-lower-case.py)||Easy|
...
|749|[shortest-completing-word](https://leetcode.com/problems/shortest-completing-word)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/749-shortest-completing-word/shortest-completing-word.py)|[:memo:](https://leetcode.com/articles/shortest-completing-word/)|Easy|
...
|774|[maximum-depth-of-n-ary-tree](https://leetcode.com/problems/maximum-depth-of-n-ary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/774-maximum-depth-of-n-ary-tree/maximum-depth-of-n-ary-tree.py)|[:memo:](https://leetcode.com/articles/maximum-depth-of-n-ary-tree/)|Easy|
...
|782|[jewels-and-stones](https://leetcode.com/problems/jewels-and-stones)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/782-jewels-and-stones/jewels-and-stones.py)|[:memo:](https://leetcode.com/articles/jewels-and-stones/)|Easy|
|783|[search-in-a-binary-search-tree](https://leetcode.com/problems/search-in-a-binary-search-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/783-search-in-a-binary-search-tree/search-in-a-binary-search-tree.py)||Easy|
...
|792|[binary-search](https://leetcode.com/problems/binary-search)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/792-binary-search/binary-search.py)|[:memo:](https://leetcode.com/articles/binary-search/)|Easy|
...
|800|[letter-case-permutation](https://leetcode.com/problems/letter-case-permutation)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/800-letter-case-permutation/letter-case-permutation.py)|[:memo:](https://leetcode.com/articles/letter-case-permutation/)|Easy|
...
|816|[design-hashset](https://leetcode.com/problems/design-hashset)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/816-design-hashset/design-hashset.py)||Easy|
|817|[design-hashmap](https://leetcode.com/problems/design-hashmap)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/817-design-hashmap/design-hashmap.py)||Easy|
...
|822|[unique-morse-code-words](https://leetcode.com/problems/unique-morse-code-words)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/822-unique-morse-code-words/unique-morse-code-words.py)|[:memo:](https://leetcode.com/articles/unique-morse-code-words/)|Easy|
...
|829|[subdomain-visit-count](https://leetcode.com/problems/subdomain-visit-count)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/829-subdomain-visit-count/subdomain-visit-count.py)|[:memo:](https://leetcode.com/articles/subdomain-visit-count/)|Easy|
...
|838|[design-linked-list](https://leetcode.com/problems/design-linked-list)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/838-design-linked-list/design-linked-list.py)||Easy|
...
|857|[positions-of-large-groups](https://leetcode.com/problems/positions-of-large-groups)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/857-positions-of-large-groups/positions-of-large-groups.py)|[:memo:](https://leetcode.com/articles/positions-of-large-groups/)|Easy|
...
|861|[flipping-an-image](https://leetcode.com/problems/flipping-an-image)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/861-flipping-an-image/flipping-an-image.py)|[:memo:](https://leetcode.com/articles/flipping-an-image/)|Easy|
...
|882|[peak-index-in-a-mountain-array](https://leetcode.com/problems/peak-index-in-a-mountain-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/882-peak-index-in-a-mountain-array/peak-index-in-a-mountain-array.py)|[:memo:](https://leetcode.com/articles/peak-index-in-a-mountain-array/)|Easy|
...
|898|[transpose-matrix](https://leetcode.com/problems/transpose-matrix)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/898-transpose-matrix/transpose-matrix.py)|[:memo:](https://leetcode.com/articles/transpose-matrix/)|Easy|
...
|919|[projection-area-of-3d-shapes](https://leetcode.com/problems/projection-area-of-3d-shapes)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/919-projection-area-of-3d-shapes/projection-area-of-3d-shapes.py)|[:memo:](https://leetcode.com/articles/projection-area-of-3d-shapes/)|Easy|
...
|941|[sort-array-by-parity](https://leetcode.com/problems/sort-array-by-parity)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/941-sort-array-by-parity/sort-array-by-parity.py)|[:memo:](https://leetcode.com/articles/sort-array-by-parity/)|Easy|
...
|950|[x-of-a-kind-in-a-deck-of-cards](https://leetcode.com/problems/x-of-a-kind-in-a-deck-of-cards)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/950-x-of-a-kind-in-a-deck-of-cards/x-of-a-kind-in-a-deck-of-cards.py)|[:memo:](https://leetcode.com/articles/x-of-a-kind-in-a-deck-of-cards/)|Easy|
...
|958|[sort-array-by-parity-ii](https://leetcode.com/problems/sort-array-by-parity-ii)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/958-sort-array-by-parity-ii/sort-array-by-parity-ii.py)|[:memo:](https://leetcode.com/articles/sort-array-by-parity-ii/)|Easy|
...
|965|[unique-email-addresses](https://leetcode.com/problems/unique-email-addresses)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/965-unique-email-addresses/unique-email-addresses.py)|[:memo:](https://leetcode.com/articles/unique-email-addresses/)|Easy|
...
|981|[delete-columns-to-make-sorted](https://leetcode.com/problems/delete-columns-to-make-sorted)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/981-delete-columns-to-make-sorted/delete-columns-to-make-sorted.py)|[:memo:](https://leetcode.com/articles/delete-columns-to-make-sorted/)|Easy|
...
|1001|[n-repeated-element-in-size-2n-array](https://leetcode.com/problems/n-repeated-element-in-size-2n-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1001-n-repeated-element-in-size-2n-array/n-repeated-element-in-size-2n-array.py)|[:memo:](https://leetcode.com/articles/n-repeated-element-in-size-2n-array/)|Easy|
...
|1005|[univalued-binary-tree](https://leetcode.com/problems/univalued-binary-tree)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1005-univalued-binary-tree/univalued-binary-tree.py)|[:memo:](https://leetcode.com/articles/univalued-binary-tree/)|Easy|
...
|1013|[fibonacci-number](https://leetcode.com/problems/fibonacci-number)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1013-fibonacci-number/fibonacci-number.py)||Easy|
...
|1019|[squares-of-a-sorted-array](https://leetcode.com/problems/squares-of-a-sorted-array)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1019-squares-of-a-sorted-array/squares-of-a-sorted-array.py)|[:memo:](https://leetcode.com/articles/squares-of-a-sorted-array/)|Easy|
...
|1026|[string-without-aaa-or-bbb](https://leetcode.com/problems/string-without-aaa-or-bbb)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1026-string-without-aaa-or-bbb/string-without-aaa-or-bbb.py)|[:memo:](https://leetcode.com/articles/string-without-aaa-or-bbb/)|Medium|
...
|1041|[available-captures-for-rook](https://leetcode.com/problems/available-captures-for-rook)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1041-available-captures-for-rook/available-captures-for-rook.py)||Easy|
...
|1044|[find-common-characters](https://leetcode.com/problems/find-common-characters)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1044-find-common-characters/find-common-characters.py)||Easy|
...
|1047|[maximize-sum-of-array-after-k-negations](https://leetcode.com/problems/maximize-sum-of-array-after-k-negations)|[Python](https://github.com/rzhangpku/leetcode/blob/master/solutions/1047-maximize-sum-of-array-after-k-negations/maximize-sum-of-array-after-k-negations.py)||Easy|
